    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InComings", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InComingVideoName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InComingCategories", x => new { x.InComingVideoName, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_InComingCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InComingCategories_InComings_InComingVideoName",
                        column: x => x.InComingVideoName,
            ...
            migrationBuilder.InsertData(
                table: "InComings",
                columns: new[] { "Name", "Description", "OutDate", "TrailerUrl" },
                values: new object[] { "Sahmaran", "DATABASES", new DateTime(2023, 1, 8, 18, 21, 52, 813, DateTimeKind.Local).AddTicks(4973), "videobaza" });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Name", "Age", "Description", "ImageUrl", "TrailerUrl", "VideoDescription", "VideoImageUrl", "VideoName", "VideoUrl", "Year" },
                values: new object[] { "Interstellar", 13, "With humanity teetering on the brink of extinction, a group of astronauts travels through a wormhole in search of another inhabitable planet.", "https://firebasestorage.googleapis.com/v0/b/neftlixtestapi.appspot.com/o/Images%2FInterstellar%2FInterstellar.png?alt=media&token=0a6c45f5-fc92-4b66-8d50-7222ae8815b8", "https://firebasestorage.googleapis.com/v0/b/neftlixtestapi.appspot.com/o/Videos%2FMovies%2FInterstellar%2FInterstellar%20Trailer.mp4?alt=media&token=562d9a36-a3b2-411b-9525-05ccdc65e11a", "SELECT * BAZA FROM HASSANBAZA", "https://firebasestorage.googleapis.com/v0/b/neftlixtestapi.appspot.com/o/Images%2FInterstellar%2FInterstellar.png?alt=media&token=0a6c45f5-fc92-4b66-8d50-7222ae8815b8", "HassanBaza", "https://firebasestorage.googleapis.com/v0/b/neftlixtestapi.appspot.com/o/Videos%2FMovies%2FInterstellar%2FInterstellar.mp4?alt=media&token=0fbe924c-8746-4132-8440-f8331d5214f6", 2014 });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CategoryId", "InComingVideoName" },
                values: new object[,]
                {
                    { 1, "Sahmaran" },
                    { 3, "Sahmaran" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InComingCategories_CategoryId",
                table: "InComingCategories",
                column: "CategoryId");
